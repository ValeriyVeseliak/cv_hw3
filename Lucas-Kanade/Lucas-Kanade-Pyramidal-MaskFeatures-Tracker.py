...
parser.add_argument('--pyramids_number', dest='pyramids_number', type=int)
...
lk_params = {"winSize": (w, h), "maxLevel": args.pyramids_number, "criteria": (cv.TERM_CRITERIA_EPS | cv.TERM_CRITERIA_COUNT, 10, 0.03)}
